...
if __name__ == "__main__":
    ...
    # combine exchangeable keys
    alice_combined_public_key = alice_secret_key + common_public_key
    bob_combined_public_key = bob_secret_key + common_public_key

    # ...exchange combined public keys between alice and bob
    print("Combined public keys are exchanged ...")

    # create common private key
    alice_common_secret_key = alice_secret_key + bob_combined_public_key
    bob_common_secret_key = bob_secret_key + alice_combined_public_key
